...
# -------------- PyQt6 Library ------------------------------------
from PyQt6.QtWidgets import QApplication, QWidget, QPushButton, QVBoxLayout, QHBoxLayout, QLabel, QFileDialog, QProgressBar, QFrame, QMessageBox
...
class ImageToIconeApp(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('IRDrone make icon')
